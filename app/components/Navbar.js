...
export default function Navbar(){
    return(
        <>
            <div className="container-fluid justify-between p-2 bg-white flex flex-row gap-3 content-center">
                <div className="flex text-center flex-row gap-3">
                    <Link href="/">
                        <h1 className="relative group text text-purple-900">
                        SockText
                        <span className="absolute left-0 -bottom-1 h-[2px] w-0 bg-purple-900 transition-all duration-300 group-hover:w-full" />
                    </h1>
                    </Link>
                    <Link href="/">
                        <h1 className="relative group text text-black">
                        Home
